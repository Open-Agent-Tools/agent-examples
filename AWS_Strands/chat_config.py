#!/usr/bin/env python3
"""
Configuration management for AWS Strands Chat Loop.
...
class ChatConfig:
    ...
    def get(self, key: str, default: Any = None, agent_name: Optional[str] = None) -> Any:
        """
    ...
    def get_section(self, section: str, agent_name: Optional[str] = None) -> Dict[str, Any]:
        """
